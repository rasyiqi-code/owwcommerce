  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - paragraph [ref=e6]:
        ...
        - textbox "Username or Email Address" [ref=e8]
      - generic [ref=e9]:
    ...
    - paragraph [ref=e19]:
      - link "Lost your password?" [ref=e20] [cursor=pointer]:
        - /url: http://crediblemark.local/wp-login.php?action=lostpassword
    - paragraph [ref=e21]:
      - link "← Go to Crediblemark" [ref=e22] [cursor=pointer]:
        - /url: http://crediblemark.local/
```